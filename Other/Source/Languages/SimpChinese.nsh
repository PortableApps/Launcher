${LangFileString} LauncherFileNotFound "无法启动$AppNamePortable。重新安装也许可以修正该错误（错误：没有找到$MissingFileOrPath）。"
${LangFileString} LauncherAlreadyRunning "另一个$AppName正在运行，请在启动$AppNamePortable前关闭$AppName。"
